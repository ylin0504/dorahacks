...
1. Navigate to the [Hackathon page](https://dorahacks.io/hackathon). Click **Create Hackathon**.
...
1. **In your Dashboard:**
    ...
    - Choose **Create Manually** (standard) or **Create with AI** (for BUIDL AI subscribers).
...
2. Click the **Checklist** (top-right) to review the required information.
    - Upload a banner, set prize pool & timeline, add tags & detailed descriptions. ([Prep Materials Checklist](https://dorahacks.io/blog/host-your-own-hackathons/) – Tips for crafting a clear and engaging description)
...
### **Step 3: Set Up Tracks & Bounties (Optional)**

**Important: After launch, only track/bounty names can be edited. Contact support to remove incorrect entries.*

**Tracks**

- Create tracks via the **Tracks** interface.
- **Set maximum track selections** per project and require hackers to select one or more tracks when submitting their BUIDL.
...
a. Go to **Bounty Settings** → **Settings & Sponsors**
...
Configure bounty details and requirements:
...
Reach out via Telegram: @dorahacksofficial or [Discord](https://discord.gg/gKT5DsWwQ5) to discuss further details.

Once everything is ready,  we’ll launch your event on the DoraHacks platform within 1-2 business days.

### **Step 5: Manage Your Hackathon**
