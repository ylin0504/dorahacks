...
BUIDL AI will **simplify hackathon management, boost efficiency, and maximize impact**. Some features are available now—with more updates coming soon. Stay tuned!
...
- **Publish Tracks tab:** 
Click **Publish Tracks** to show these Tracks as a tab on your public hackathon page (optional).
...
- **Export CSV:** Click "Export" to download selected BUIDL details as CSV.
...
- Head over to the **Group Messages** section to broadcast notifications.
    ...
    Target your message to specific groups:
...
- Go to **Judging & Results > Prize & Judging** to set up prize categories.
...
> 
> *· After the hackathon ends, run AI Judges on each bounty to score submissions according to the judging criteria.*
> 
...
1. After marking and publishing winners using the **Winner Assignment Tool**, your hackathon marketing summary will **auto-generate in 12 hours**.

2. Get notified by email, then edit/publish via **Organizer Dashboard > Summary**.
...
For any questions, feel free to reach out to us through Telegram @dorahacksofficial or [Discord](https://discord.gg/gKT5DsWwQ5) to contact DoraHacks for assistance.
